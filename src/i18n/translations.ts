...
export const translations: Record<Locale, Record<string, string>> = {
  ...
  th: {
    ...
    "hero.badge": "สร้างบน DannyChain × Bitget Wallet",
    "hero.title1": "ขุด",
    "hero.title2": "HMOOB",
    "hero.title3": "รับรายได้ทุกวัน",
    "hero.desc": "เชื่อมต่อผ่าน Bitget Wallet เพิ่มอัตราแฮช และขุดเหรียญ HMOOB — ไม่ต้องใช้อุปกรณ์ รับ",
    "hero.roi": "365% ROI",
    "hero.descEnd": "ตลอด 365 วันบนระบบนิเวศ DannyChain",
    "hero.startMining": "เริ่มขุด",
    "hero.downloadWallet": "ดาวน์โหลด Bitget Wallet",
    ...
    "about.p1": "HMOOB Mining เป็นแพลตฟอร์มขุดคริปโตบนคลาวด์ที่สร้างบน DannyChain Layer 2 blockchain ผู้ใช้เชื่อมต่อผ่าน",
    "about.bitget": "Bitget Wallet",
    "about.p1End": "แอป — กระเป๋า Web3 ที่เชื่อถือได้มีผู้ใช้กว่า 80 ล้านคน — เพื่อขุดเหรียญ HMOOB โดยซื้อแผน Boost และรับรางวัลทุกวัน โดยไม่ต้องใช้ฮาร์ดแวร์ใดๆ",
    ...
    "appPreview.desc": "HMOOB Mining ทำงานได้อย่างราบรื่นผ่าน",
    "appPreview.descEnd": "แอป — กระเป๋า Web3 ที่เชื่อถือได้มีผู้ใช้กว่า 80 ล้านคนทั่วโลก เพียงเปิด hmoob.io ในเบราว์เซอร์ DApp ของกระเป๋าเพื่อเข้าถึงทุกฟีเจอร์",
    "appPreview.desc2": "Bitget Wallet มีความปลอดภัยแบบ self-custodial รองรับหลายเชน และเบราว์เซอร์ DApp ในตัว — ทำให้เป็นประตูที่สมบูรณ์แบบสู่ HMOOB Mining และระบบนิเวศ DannyChain",
    "appPreview.openApp": "เปิด HMOOB Mining",
    "appPreview.getWallet": "ดาวน์โหลด Bitget Wallet",
    ...
    "flow.dexDesc": "ตลาดแลกเปลี่ยนแบบกระจายศูนย์ — สลับเหรียญและเพิ่มสภาพคล่อง",
    "flow.scanDesc": "สำรวจ Blockchain — ติดตามธุรกรรม บล็อก และกระเป๋าเงิน",
    ...
    "cta.badge": "รักษาความปลอดภัยโดย DannyChain Layer 2 × Bitget Wallet",
    "cta.title1": "เริ่มขุด",
    "cta.title2": "HMOOB",
    "cta.titleEnd": "วันนี้",
    "cta.desc": "เข้าร่วมนักขุดกว่า 3,300 คนที่รับรางวัลทุกวันด้วย 365% ROI ต่อปี",
    "cta.steps": "ดาวน์โหลด Bitget Wallet → เปิด hmoob.io ในเบราว์เซอร์ DApp → เชื่อมต่อกระเป๋า → เลือก Boost → เริ่มขุดทันที",
    ...
    "cta.getWallet": "ดาวน์โหลด Bitget Wallet",
