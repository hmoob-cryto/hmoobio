    ...
    <section className="section-fade py-28 bg-surface relative overflow-hidden">
      ...
      <div className="container text-center relative">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {testimonials.map((t) => (
            <div key={t.id} className="border-glow rounded-2xl p-7 bg-background text-left group transition-all duration-500 hover:-translate-y-1">
              ...
              <div className="flex gap-3 mb-5">
                ...
                <div className="flex-1 rounded-lg bg-surface p-2.5 text-center">
                  ...
                  <div className="text-sm font-display font-bold mt-0.5">{t.boost_tier}</div>
                </div>
              </div>
